...
extension SearchViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        villes.append(SearchViewController.citiesCapitals[indexPath.row]) //On ajoute la ville séléctionnée dans le popup
        villes.sort()
        ...
        SearchViewController.citiesCapitals.remove(at: indexPath.row) //On met à jour la liste des villes proposées pour ne pas ajouter plusieurs fois la même ville
        SearchViewController.citiesCapitals.sort()
